				   ...
				   <div class="topnavifloat">
					 ...
					 <nav>
			        		  <ul>
								...
								<li  class="active"><a href="<%=path %>/welcome/Contact" class="scroll">CONTACT US</a></li>
							</ul>
		        	</nav>
					</div>
					</div>
	...
	<div id="body">
		...
		<div class="content">
			...
			<header class="case_right_f">
                <div class="case_right_f_l">Contact</div>
                <div class="case_right_f_r">
                    ...
                    <a href="<%= request.getContextPath()%>/welcome/Contact">Contact</a>
                </div>
                <div class="clear"></div>
            </header>
                                                      <!--正文-->			
