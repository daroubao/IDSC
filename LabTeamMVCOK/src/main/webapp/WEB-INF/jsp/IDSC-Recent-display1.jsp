...
<body>
	...
	<div style="width:1304x;margin:0 auto;text-align:left;">
		<div class="left">
			<div class="AM">
				...
				<ul>
					...
					<li><span><a
							href="<%=request.getContextPath()%>/recent/meeting"><span>Meeting</span></a></span></b></span></li>
				</ul>
			</div>
		</div>
		...
		<div class="right">
			<div id="body">
				<div class="content">
					<a name="News"> <header class="case_right_f">
						<div class="case_right_f_l">NEWS</div>
						<div class="case_right_f_r">
							<a href="<%=path %>/index">HOME</a>&gt <a href="<%=path %>/recent/r">EVENTS</a>&gt <a
								href="<%=path %>/recent/r">News</a>
						</div>
						</header> <c:if test="${!empty list }">
							<c:forEach items="${list}" var="li">
								
								<header class="case_right_N">
								<div class="case_right_N_le">
									<a href="<%=request.getContextPath()%>/recent/${li.RUrl}">
									<h5 class="product-buyer-name">${li.rthem }</h5></a>
								</div>
								<div class="case_right_N_ri">
									<a href="">${li.rdate }</a>
								</div>
	...
	<div id="footer">
		<div class="copy-right">
			<p style="text-align:center;">Copyright &copy; 2016-2017. IDSC
				Joint Laboratory.</p>
		</div>
	</div>
</body>
