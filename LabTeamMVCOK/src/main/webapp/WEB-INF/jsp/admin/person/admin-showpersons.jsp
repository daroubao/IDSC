...
<body>
	...
	<div id="section">
		<table border="0" width="1100px">
			<tr>
				<td align="center" style="font-size:24px; color:#666">教师管理</td>
			</tr>
			<tr>
				<td align="right"><a href="<%=path %>/admin/addperson"><span id="addcolor">添加</span></a></td>
			</tr>
		</table>
		<br />
		...
		<c:forEach var="p" items="${list }">
				<tr>
					...
					<td align="center">${p.pposition }</td>
					<td align="center">${p.paddress }</td>
					<td align="center">${p.ptel }</td>
					<td align="center">${p.pemail }</td>
